/**
 * Arrays are objects in Java, we are dealing with references. They have one member and it is the length member. You cannot add variables or methods to the array. In Java we have arrays of arrays. 
 */
public class array {
    ...
    public static void main(String [] args) {
        ...
        // Create arrays, the int withing the brackets is the SIZE
        intArray = new int[10];
        ...
        //Point [] myPoints = {new Point(), new Point(3, 4)};
